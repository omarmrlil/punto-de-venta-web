                ...
                <table id="datatablesSimple" class="table table-striped fs-6">
                    ...
                    <tbody>
                        @foreach ($presentaciones as $item)
                            <tr>
                                <td>{{ $item->caracteristica->nombre ?? 'N/A' }}</td>
                                <td>{{ $item->sigla ?? 'N/A' }}</td>
                                <td>{{ $item->caracteristica->descripcion ?? 'N/A' }}</td>
                                <td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="{{ route('presentaciones.destroy', ['presentacione' => $item->id]) }}"
                                                method="post">
                                                @method('DELETE')
                                                @csrf
