    ...
    <div class="card text-bg-light">
        <form action="{{ route('proveedores.update', ['proveedore' => $proveedore]) }}" method="post">
            ...
            <div class="card-header">
                <p>Tipo de proveedor: <span class="fw-bold">{{ strtoupper($proveedore->persona->tipo) }}</span>
                </p>
            </div>
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <label for="razon_social" class="form-label">
                            {{ $proveedore->persona->tipo == 'Natural' ? 'Nombres y apellidos:' : 'Nombre de la
                            empresa:' }}
                        </label>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="documento_id" id="documento_id">
                            ...
                            <option value="{{ $item->id }}" {{ old('documento_id')==$item->id ? 'selected' : '' ||
                                $proveedore->persona->documento_id == $item->id }}>
                                {{ $item->nombre }}
                            </option>
                            @endforeach
                        </select>
