            ...
            <table id="datatablesSimple" class="table table-striped fs-6">
                ...
                <tbody>
                    @foreach ($proveedores as $item)
                        <tr>
                            <td>{{ $item->persona?->razon_social ?? 'N/A' }}</td>
                            <td>{{ $item->persona?->direccion ?? 'N/A' }}</td>
                            <td>
                                <p class="text-muted mb-0">
                                    {{ $item->persona?->documento?->nombre ?? 'N/A' }}: <!-- Tipo de documento -->
                                    {{ $item->persona?->numero_documento ?? 'N/A' }} <!-- Número de documento -->
                                </p>
                            </td>
                            <td>{{ $item->persona?->tipo ?? 'N/A' }}</td>
                            <td>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        {{ $item->persona?->estado == 1 ? '¿Seguro que quieres desactivar este proveedor?' : '¿Seguro que quieres reactivar este proveedor?' }}
                                    </div>
